    ...
    pub mod axoloto210 {
        pub mod glitch_art {
            ...
            pub mod png_glitchable {
                ...
                #[doc(hidden)]
                macro_rules! __export_axoloto210_glitch_art_png_glitchable_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "axoloto210:glitch-art/png-glitchable#glitch")] unsafe extern "C"
                        fn export_glitch(arg0 : i32, arg1 : * mut u8, arg2 : usize,) -> *
                        mut u8 { unsafe { $($path_to_types)*:: _export_glitch_cabi::<$ty
                        > (arg0, arg1, arg2) } } #[unsafe (export_name =
                        "cabi_post_axoloto210:glitch-art/png-glitchable#glitch")] unsafe
                        extern "C" fn _post_return_glitch(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_glitch::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_axoloto210_glitch_art_png_glitchable_cabi;
...
macro_rules! __export_png_glitcher_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::axoloto210::glitch_art::png_glitchable::__export_axoloto210_glitch_art_png_glitchable_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::axoloto210::glitch_art::png_glitchable);
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:axoloto210:glitch-art:png-glitcher:encoded world"
)]
#[doc(hidden)]
...
line\x03\0\x03\x01@\x01\x09scan-line\x04\0\x04\x04\0\x06glitch\x01\x05\x04\0$axo\
loto210:glitch-art/png-glitchable\x05\0\x04\0\"axoloto210:glitch-art/png-glitche\
r\x04\0\x0b\x12\x01\0\x0cpng-glitcher\x03\0\0\0G\x09producers\x01\x0cprocessed-b\
