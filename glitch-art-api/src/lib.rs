...
use bindings::axoloto210::glitch_art::png_glitchable::FilterType as WasmFilterType;
use bindings::axoloto210::glitch_art::png_glitchable::ScanLine as WasmScanLine;
use bindings::axoloto210::glitch_art::png_glitchable::glitch;
